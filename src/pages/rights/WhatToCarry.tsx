...
export default function WhatToCarry() {
  ...
  return (
    <InfoPageLayout title={t('whatToCarry')}>
      ...
      <section>
        <h2 className="text-2xl font-bold mb-4 font-display">What to Carry</h2>
      ...
      <section>
        <h2 className="text-2xl font-bold mb-4 font-display">If You Have Immigration Documents</h2>
      ...
      <section>
        <h2 className="text-2xl font-bold mb-4 font-display">What NOT to Carry</h2>
        <ul className="list-none space-y-2 mb-4">
          <li className="flex items-start gap-3 text-lg">
            <span className="text-primary font-bold text-2xl leading-none">•</span>
      ...
      <section>
        <h2 className="text-2xl font-bold mb-4 font-display">Keep Your Phone Secure</h2>
        <p className="text-lg leading-relaxed mb-4">
      ...
      <section>
        <h2 className="text-2xl font-bold mb-4 font-display">Create a Family Safety Plan</h2>
        <ul className="list-none space-y-2 mb-4">
          <li className="flex items-start gap-3 text-lg">
            <span className="text-primary font-bold text-2xl leading-none">•</span>
